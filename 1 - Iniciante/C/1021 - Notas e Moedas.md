...
```
```
TEM ALGO DE ERRADO NA MINHA LOGICA, POIS NÃO CONSEGUIR APROXIMAR O VALOR DA VARIAVEL VALOR , 
PARA 2 CASAS DECIMAIS NO FLOAT, 
VOU TERMINAR OUTRAS E RETORNO PARA ESSE DESAFIO.
```
